...
import Prevoustimesheetinsert from '@salesforce/apex/Timesheet.PreviousTimesheetApex';
export default class Intellibee_Timesheet extends LightningElement {
  ...
  apexprojectinsertion() {
    this.isSaved = true;
    timesheetinsert({ project: JSON.stringify(this.projectData), timesheetweekstartdate: this.submitWeekStart });

  }


  WeekDayinput = ['Task', { id: 'in0', label: 'Sun', value: '' }, { id: 'in1', value: '' }, { id: 'in2', value: '' }, { id: 'in3', value: '' }, { id: 'in4', value: '' }, { id: 'in5', value: '' }, { id: 'in6', value: '' }, { id: 'in7', value: '' }, 'Remarks']
  ...
  previousTimesheet() {
    ...
    this.total = 0
    // var s= new Date(this.y, this.m, this.d - (this.day))   //.toDateString();
    // console.log(s)
    Prevoustimesheetinsert({ Date1: this.submitWeekStart });
  }
  ...
  createTimesheetRecord() {
    var projectID2 = PROJECTID({ projectNameLookup: this.projectname })
      .then(result => {
        this.projectIdValue = result;
        console.log("recordID: " + result);

        var fields = {
          'Week_Start_Date__c': this.submitWeekStart, 'Project__c': result,
